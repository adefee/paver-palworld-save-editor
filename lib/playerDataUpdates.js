  ...
  switch (filename) {
    case 'Level.sav':
      returnValue = {
        level: {
          ...
          type: 'IntProperty',
          validate: (val) => Number.isInteger(val) && val >= 0 && (enableGuardrails && val <= 50),
        ...
        handle: {
          ...
          type: 'StrProperty',
          validate: (val) => val.length > 0 && (enableGuardrails && val <= 20),
        ...
        hunger: {
          ...
          validate: (val) => typeof val === 'number' && val >= 0 && (enableGuardrails && val <= 100),
        ...
        isPlayer: {
          ...
          type: 'BoolProperty',
          validate: (val) => typeof val === 'boolean' && (enableGuardrails && val !== false),
        ...
        voiceId: {
          ...
          type: 'IntProperty',
          validate: (val) => Number.isInteger(val) && (enableGuardrails && val >= 1 && val <= 6),
    ...
    case 'Player.sav':
      returnValue = {
        ...
        relicsInPossession: {
          info: "This may be a count of unspent effigy points for the player.",
          parameterId: null,
        ...
        appearance: {
          ...
          bodyType: {
            ...
            type: 'StrProperty',
            validate: (val) => val.length > 0 && (enableGuardrails && (val === 'TypeA' || val === 'TypeB')),
