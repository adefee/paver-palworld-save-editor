        ...
        appearance: {
          ...
          torsoSize: {
            ...
            validate: (val) => enableGuardrails ?
              typeof val === 'number' && val >= 0 && val <= 100 :
              typeof val === 'number' && val >= 0,
            validationError: "torsoSize should be a decimal (float) between 1 and 100. The ingame default is 50.",
          },
          armSize: {
            ...
            validate: (val) => enableGuardrails ?
              typeof val === 'number' && val >= 0 && val <= 100 :
              typeof val === 'number' && val >= 0,
            validationError: "armSize should be a decimal (float) between 1 and 100. The ingame default is 50.",
          },
          legSize: {
